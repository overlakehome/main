...
public class oyster {
    public static class ArrayAndStrings {
        ...
        // 1.7. Write an algorithm such that if an element in an MxN matrix is
    ...
    public static class LinkedLists {
        public static class SNode<T> implements Comparable<SNode<T>> {
            ...
            // 2.1. Write code to remove duplicates from an unsorted linked
            // list.
            ...
            // 2.4. You have two numbers represented by a linked list, where
            ...
            // EXAMPLE: Input: A -> B -> C -> D -> E -> C [the same C as
            // earlier]
            // Output: C
